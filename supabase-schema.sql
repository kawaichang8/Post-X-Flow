...
-- Function: Initialize subscription on user signup (7-day trial)
...
-- Migrate existing users: Create subscription records with trial
INSERT INTO user_subscriptions (user_id, subscription_status, trial_started_at, trial_ends_at)
SELECT 
  id,
  'trial',
...
-- ============================================
-- PROMOTION SETTINGS (user-configurable)
-- ============================================
